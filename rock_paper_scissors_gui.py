...
# def update_status():
#     """Update the labels to show players' progress."""
#     status_text.set(f"Player 1: {'Chosen' if player1_choice else 'Waiting...'} | "
#                     f"Player 2: {'Chosen' if player2_choice else 'Waiting...'}")

# def set_choice(player, choice):
#     """Set the choice for a player and proceed if both have chosen."""
#     global player1_choice, player2_choice
...
# # Status label to show which player needs to choose
# status_text = tk.StringVar()
# status_text.set("Player 1: Waiting... | Player 2: Waiting...")
...
# # Player 2 choices
# tk.Label(root, text="Player 2, choose an option:", font=("Arial", 14)).pack(pady=15)
# for choice in ["Rock", "Paper", "Scissors"]:
#     tk.Button(root, text=choice, font=("Arial", 12), 
#               command=lambda c=choice: set_choice(2, c)).pack(pady=2)
